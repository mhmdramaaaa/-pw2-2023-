...
if(isset($_GET['id'])){
    ...
    if($locations->delete()){
        ...
        echo "Gagal menghapus locations.";
    }
}
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="index.php">locations</a>
                                            <a class="nav-link" href="../weather_forecasts/index.php">weather Forecasts</a>
                                            <a class="nav-link" href="src/pages/weather_reports/index.php">Weather Reports</a>
                                            <a class="nav-link" href="src/pages/weather_types/index.php">Weather Type</a>
                                        </nav>
                                    </div>
