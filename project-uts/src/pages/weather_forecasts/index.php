...
if(isset($_GET['id'])){
    ...
    if($weather_forecasts->delete()){
        header("Location: index.php");
    }else{
        echo "Gagal menghapus weather_forecasts.";
    }
}

// Tampilkan data dari method index
$data = $weather_forecasts->index();
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <div id="layoutSidenav">
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                         <nav class="sb-sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="index.php">weather Forecasts</a>
                                            <a class="nav-link" href="../weather_reports/index.php">Weather Reports</a>
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                        <h1 class="mt-4">weather_forecasts</h1>
                        ...
                        <tbody>
                            ...
                            foreach($data as $row) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $row['high_temperature']; ?></td>
                                    <td><?php echo $row['low_temperature']; ?></td>
